# Ableton Max for Live device: br.stutter.b.1.0
...
A Max for Live device that is built around the Max/MSP stutter~ object. This contains all features as the br.stutter.a.1.0 but with extras. This effect adds LFOs in sync with each grain that can manipulate a filter, amplitude, and panning.
...
Copy and paste br.stutter.b.1.0.amxd into that folder
